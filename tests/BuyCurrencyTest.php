...
use Bartosz\CurrencyExchanger\BuyCurrency;
...
#[CoversClass(BuyCurrency::class)]
class BuyCurrencyTest extends TestCase
{
    #[Test]
    #[DataProvider('exchangeResultsDataProvider')]
    public function itExchangesMoneyBasedOnExchangeRateAndAddsAFee(
        Money $expected,
        Money $money,
        Currency $toCurrency
    ): void {
        $exchangeMoney = new BuyCurrency(new ExchangeCurrency(new InMemoryExchangeRateRepository()));
